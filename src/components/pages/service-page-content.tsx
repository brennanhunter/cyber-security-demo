...
export default function ServicePageContent({ service }: ServicePageContentProps) {
  const ctaBtnRef = useRef<ScrambleTextHandle>(null)
    ...
    <PageWrapper>
      ...
      <section className="relative py-24 md:py-32 bg-raisin-black overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-12 left-8 opacity-70 transform -rotate-6">
            <img 
          ...
          <div className="absolute top-1/4 left-16 opacity-50 transform rotate-45">
            <img 
              src="/decorations/triangles.png" 
              alt=""
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {service.heroSection?.ctaText && service.heroSection?.ctaLink && (
              <a 
                ...
                onMouseEnter={() => ctaBtnRef.current?.startScramble()}
              >
                <span className="relative z-10">
                  <ScrambleText ref={ctaBtnRef}>
