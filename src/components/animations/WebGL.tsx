...
function generateColor(): { r: number; g: number; b: number } {
    // Your cybersecurity color palette - strict theme
    const colors = [
        { r: 25, g: 53, b: 192 },   // electric-blue #1935c0
        { r: 140, g: 31, b: 105 },  // steel-pink #8c1f69
        { r: 81, g: 31, b: 100 },   // finn-purple #511F64
        { r: 43, g: 143, b: 171 },  // cyber-cyan #2b8fab
    ];
    ...
    const brightnessMultiplier = 0.15; // Pavel's original brightness
